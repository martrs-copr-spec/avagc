...
Version: 0.6.6
Release: 2%{dist}
Source0: https://github.com/Cygn/pulseaudio-dlna/archive/refs/tags/%{name}-%{version}-1.tar.gz
Patch0: %{name}-%{version}_jsonstr.patch
License: GPLv3
...
%changelog
* Mon Feb 20 2023 Martin RS
- add utf8 pass-through in json, add %dist in Release
